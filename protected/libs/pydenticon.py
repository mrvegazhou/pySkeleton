...
def genarateAvatar(self, email):
    ...
    # digest.
    generator = Generator(5, 5, digest=hashlib.sha1,
                                 foreground=foreground, background=background)
    return generator.generate(email, 200, 200, output_format="png")
...
if __name__=='__main__':
    ...
    generator = Generator(5, 5, digest=hashlib.sha1,
                                 foreground=foreground, background=background)
    identicon_png = generator.generate("vega@qq.com", 200, 200, output_format="png")
